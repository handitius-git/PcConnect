...
function render_header(string $title, ?array $user = null): void
{
    ...
    if ($user) {
        ...
        if (is_full_admin($user)) {
            ...
            echo '<details name="nav_top"><summary>Reports</summary><div class="menu"><a href="' . route_url('reports') . '">Report Preventive Maintenance</a><a href="' . route_url('maintenance_status_report') . '">Report Status PC/Printer</a><a href="' . route_url('corrective_repairs') . '">Report Corrective Maintenance</a></div></details>';
