...
window.onMasterItemInput = async function(q){
    ...
    try {
        ...
        if(!Array.isArray(items) || items.length === 0){
            sResults.innerHTML = "<div style=\"padding:12px 14px;color:#94a3b8;font-size:13px;text-align:center;\">Tidak ditemukan barang yang cocok dengan \"<strong>" + escapeHtml(q) + "</strong>\".</div>";
...
window.selectMasterItemObj = async function(it){
    ...
    if(sHint) sHint.innerHTML = "<span style=\"color:#166534;font-weight:600;\">✓ Terpilih: " + it.item_name + "</span>";
...
window.clearMasterItem = function(){
    ...
    if(sResults) sResults.style.display = "none";
    if(sHint) sHint.textContent = "Ketik nama barang untuk mencari katalog atau isi form secara manual.";
};
